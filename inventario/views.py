...
def modelo_inventario(request):
    if request.method == 'POST':
        ...
        if metodo == 'numeros':
            ...
            retraso= calculoMontecarloLista(valor1,px1,retra)
            lvalor1=retraso[0]
            lpx1=retraso[1]
            lfrecuen1=retraso[2]
            ldesde1=retraso[3]
            ...
            for i in range(0,len(retraso[0])):
                l_retra.append({'valor':lvalor1[i],'px':lpx1[i],"frecuencia":lfrecuen1[i],"desde":ldesde1[i],"hasta":lhasta1[i]})

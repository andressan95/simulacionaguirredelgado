...
def caso_estudio(request):
    ...
    if request.method == 'POST':
            ...
            if metodo == 'numeros':
                ...
                return render(request, 'casoestudio/index.html',
                ...
                return render(request, 'casoestudio/index.html',
                              {'n':n,'promtEspera':promtEspera,'promtSistema':promtSistema,
    ...
    return render(request, 'casoestudio/index.html', {'datosLlegadas': datosLlegadas, 'datosServicio': datosServicio})
